...
public class Palpite implements java.io.Serializable {
    ...
    public Palpite(PalpiteId id, JogoidDAO jogoid, UsuarioDAO usuario, Bolao bolao, int nrGols1, Date dtAposta, int nrGols2) {
        this.id = id;
        this.jogoid = jogoid;
    ...
    public Palpite(PalpiteId id, JogoidDAO jogoid, UsuarioDAO usuario, Bolao bolao, int nrGols1, Date dtAposta, Date dtUltimaatt, int nrGols2, String stPalpite, Resultadopalpite resultadopalpite) {
        this.id = id;
        this.jogoid = jogoid;
        this.usuario = usuario;
        this.bolao = bolao;
