...
/**
 * ResultadopalpiteId generated by hbm2java
 */
@Embeddable
public class ResultadopalpiteId  implements java.io.Serializable {
    ...
    public ResultadopalpiteId() {
    }

    public ResultadopalpiteId(int cdJogo, String cdUsuario, long cdBolao) {
       this.cdJogo = cdJogo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ResultadopalpiteId) ) return false;
		 ResultadopalpiteId castOther = ( ResultadopalpiteId ) other; 
